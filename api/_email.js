...
<head>
  ...
  <style>
    /* Inert in email clients (screen-only rendering) — only kicks in when
       this same HTML is printed to the attached PDF via headless Chrome,
       so cards/rows don't get sliced across a page boundary. */
    @media print {
